...
INSERT INTO `code` VALUES (1,1,8,'#include <stdio.h> \n int main() \n {int a,b;scanf(\"%d %d\",&a, &b);printf(\"%d\\n\",a+b);return 0;}',1,6451,11527,'2014-04-19 01:20:06',1,1,NULL,NULL),(2,1,8,'#include <stdio.h> \n int main() \n {int a,b;scanf(\"%d %d\",&a, &b);printf(\"%d\\n\",a+b);return 0;}',1,6761,11243,'2014-04-19 01:21:01',1,1,NULL,NULL),(3,1,8,'#include <stdio.h> \n int main() \n {int a,b;scanf(\"%d %d\",&a, &b);printf(\"%d\\n\",a+b);return 0;}',1,6789,11125,'2014-04-19 01:28:41',1,1,NULL,NULL),(4,1,8,'#include <stdio.h> \n int main() \n {int a,b;scanf(\"%d %d\",&a, &b);printf(\"%d\\n\",a+b);return 0;}',0,2,495806,'2014-04-20 01:29:24',1,1,NULL,NULL),(5,1,19,'#include <stdio.h> \n int main() \n {int a,b;scanf(\"%d %d\",&a, &b);printf(\"%d\\n\",a+b);return 0;}',0,7839,11514,'2014-04-20 04:32:47',1,1,NULL,NULL),(6,1,8,'#include <stdio.h> \n int main() \n {int a,b;scanf(\"%d %d\",&a, &b);printf(\"%d\\n\",a+b);return 0;}',0,3,684000,'2014-04-21 03:15:27',1,1,NULL,NULL),(7,1,8,'#include <stdio.h> \n int main() \n {int a,b;scanf(\"%d %d\",&a, &b);printf(\"%d\\n\",a+b);return 0;}',0,7908,10909,'2014-04-21 03:18:06',1,1,NULL,NULL),(8,1,10,'#include <stdio.h> \n int main() \n {int a,b;scanf(\"%d %d\",&a, &b);printf(\"%d\\n\",a+b);return 0;}',0,3,602776,'2014-05-29 11:34:04',1,1,NULL,NULL),(9,1,8,'#include <stdio.h> \n int main() \n {int a,b;scanf(\"%d %d\",&a, &b);printf(\"%d\\n\",a+b);return 0;}',0,6095,12045,'2014-06-05 14:06:29',1,1,NULL,NULL),(10,1,8,'#include <stdio.h> \n int main() \n {int a,b;scanf(\"%d %d\",&a, &b);printf(\"%d\\n\",a+b);return 0;}',0,6123,12189,'2014-06-05 15:24:37',1,1,NULL,NULL),(11,1,8,'#include <stdio.h>\nint main()\n{\n    int a,b;\n    scanf(\"%d %d\",&a, &b);\n    printf(\"%d\\n\",a+b);\n    return 0;\n}',0,6181,11277,'2014-06-19 22:10:36',1,1,NULL,NULL);
...
CREATE TABLE `grouppro` (
  ...
  PRIMARY KEY (`gp_ID`)
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8 COMMENT='有组织的题目，如比赛/作业的题目';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `grouppro` VALUES (4,'4',10,3),(15,'4',8,5),(16,'5',8,1),(17,'5',10,2),(19,'5',14,2),(20,'4',14,4),(21,'11',8,1),(22,'11',10,2),(24,'4',11,6),(26,'4',12,1);
...
CREATE TABLE `problem` (
  ...
  PRIMARY KEY (`p_ID`)
) ENGINE=InnoDB AUTO_INCREMENT=30 DEFAULT CHARSET=utf8 COMMENT='问题';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2014-06-20 17:27:19
